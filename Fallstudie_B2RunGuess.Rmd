...
# Daten herunterladen:
B2RunGuess <- read.csv2("http://statistix.org/Data/results-survey635569.csv", na.strings = "", encoding = "UTF-8")
...
**Aufgabe**: Überlegen Sie sich eine Fragestellung die Sie mit diesen Daten analysieren können - und führen Sie die Analyse durch.
